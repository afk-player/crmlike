# Generated by Django 3.1.4 on 2020-12-04 21:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(max_length=254, verbose_name='Employee email')),
                ('bio', models.TextField(blank=True, null=True, verbose_name='Employee biography')),
                ('employee_photo', models.ImageField(null=True, upload_to='employees', verbose_name='Employee photo')),
